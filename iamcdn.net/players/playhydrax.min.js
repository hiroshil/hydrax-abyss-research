if (top.location == self.location) {
    ...
    function C(e, n) {
        t(e.g);
        var i = e.g.l;
        return i ? A(e, "return"in i ? i.return : function(e) {
            return {
                value: e,
                done: !0
            }
        }
        , n, e.g.return) : (e.g.return(n),
        B(e))
    }
    function A(e, n, i, r) {
        try {
            ...
            if (!(o instanceof Object))
                throw TypeError("Iterator result " + o + " is not an object");
            if (!o.done)
                return e.g.s = !1,
                o;
            var s = o.value
    ...
    function PLAYER(e) {
        ...
        this.h = Object.assign({
            ...
            playbackRates: [.25, .75, 1, 1.25, 1.5, 2],
            events: {
                ready: function() {
                    void 0 !== s && s.key && s.notify()
                },
                time: function() {
                    r = jwplayer().getPosition(),
                    void 0 !== s && s.key && s.putTime(r)
                },
                seek: function(e) {
                    window.TRACKER && (window.TRACKER.seek += 1),
                    i = e.offset
                },
                ...
                error: function(e) {
                    ...
                    document.getElementById("over") || (jwplayer("player").seek(s),
    ...
    function K(e, n) {
        ...
        ,
        (i = decodeURIComponent(L("logo"))) && (e.h.logo = {
            file: i,
            link: "#",
            hide: !0,
            margin: "5px",
        ...
        i && e.h.tracks.push({
            file: (-1 < i.indexOf("googleusercontent") || -1 < i.indexOf(e.D) ? "" : "https://proxy.iamcdn.net/sub?url=") + i,
            label: r || "Default",
            default: !0
        }),
    ...
    function U(e) {
        var n = setInterval(function() {
            "undefined" != typeof jwplayer && jwplayer && !document.getElementById("over") && (clearInterval(n),
            jwplayer("player").setup(e.h))
        }, 500)
    }
    function R(e, n) {
        ...
        if (i) {
            var r = Object.keys(i);
            r.splice(r.indexOf("pieceLength"), 1),
            r.splice(r.indexOf("fullHd"), 1),
            n.sources = n.sources.length > r.length ? n.sources : r
        }
        var o = setInterval(function() {
            "undefined" != typeof SoTrym && SoTrym && (clearInterval(o),
            SoTrym("player").setup({
                id: n.id || e.i,
                slug: e.i,
                useP2P: n.use_p2p,
    ...
    function T(e, n, i) {
        ...
        r.onopen = function() {
            return o = Object.assign(o, window.TRACKER ? {
        ...
        r.onmessage = function() {
            var e = setTimeout(function() {
                clearTimeout(e),
                o = Object.assign(o, window.TRACKER ? {
                    player: window.TRACKER
                } : {}),
                window.TRACKER = {
                    seek: 0,
        ...
        new Promise(function(a) {
            ...
            u.onreadystatechange = function() {
                if (4 == u.readyState) {
                    ...
                    if (!--s)
                        return this.notify("Error connecting to server. Please try again.");
                    setTimeout(function() {
    ...
    z.prototype.u = function(e) {
        return t(this.g),
        this.g.l ? A(this, this.g.l.next, e, this.g.u) : (this.g.u(e),
        B(this))
    }
    ,
    z.prototype.A = function(e) {
        return t(this.g),
        this.g.l ? A(this, this.g.l.throw, e, this.g.u) : (this.g.A(e),
        B(this))
    }
    ,
    PLAYER.prototype.load = function(e) {
        var n, i, r, o, s, a, u, l, c, h, d, g, m, y, $, b = this;
        return E(new D(new z(function(w) {
            if (1 == w.j) {
                if (e && "object" != typeof e)
                    try {
                        e = JSON.parse(e)
                ...
                if (!e || !e.status)
                    return w.return(b.notify(e ? e.msg : "Error connecting to server. Please try again."));
                if ("object" == typeof e.configJwp && (b.h = Object.assign(b.h, e.configJwp)),
                !["embed.hellacdn.com", "hellacdn.net"].includes(document.location.host)) {
                    var _ = document.createElement("img");
                    _.src = "https://connect.idocdn.com:3016/1x1.jpg?id=" + e.user_id + "&v=" + b.i,
                ...
                if (e.use_down || !e.use_down)
                    var j = setInterval(function() {
                        ...
                        if ("undefined" != typeof jwplayer && jwplayer && void 0 !== jwplayer().getPlaylist) {
                            if (document.querySelector('.jw-icon-inline[button="Abyss"]'))
                                return clearInterval(j);
                            jwplayer().addButton("https://iamcdn.net/players/logo/" + (Math.floor(19 * Math.random()) + 1) + ".png", window.iconTitle || "Free Video Hosting", function() {
                ...
                if (e.preview && O(b, b.i),
                e.subtitles && !L("prioritize"))
                    for (n = !b.h.tracks.length,
                    i = P(),
                    r = e.md5_id,
                    o = !1,
                    s = 0; s < e.subtitles.length; s++)
                        _ = e.subtitles[s],
                        a = !1,
                        n && i && !o && i.includes(_.lang.toLocaleLowerCase()) && (a = o = !0),
                        b.h.tracks.push({
                            file: b.protocol + "//" + b.D + "/" + r + "/" + _.slug + "." + _.type,
                            label: decodeURIComponent(_.lang),
                            default: a
                        });
                var x = ("ontouchstart"in window || "onmsgesturechange"in window) && navigator.userAgent.match(/UCBrowser/i);
                return b.m = e.domain + ":443",
                b.v = (e.id ? e.id : Q(b.i)) + "." + e.domain + ":443",
                window.MediaSource && !x && !/(tv|webostv|smart-tv|smarttv|googletv|appletv|directfb|gtv100|freebsd|nettv|dtv|hbbtv|netcast|pov_tv|dvp|smarthub)/.test(navigator.userAgent.toLocaleLowerCase()) ? w.return(R(b, e)) : ((u = e.sources) && u.length ? (w.j = 2,
                w = void 0) : w = v(w, N(b, b.protocol + "//" + b.m, "POST", "slug=" + b.i)),
                w)
            }
            if (2 != w.j) {
                if (!(l = w.B) || !l.status || void 0 === l.sources)
                    return l ? b.notify("We're processing this video. Please check back later") : b.notify("Error loading media: Unknown network error"),
                    w.return();
                u = l.sources
            }
            ...
            if (q) {
                var H = Object.keys(q);
                H.splice(H.indexOf("pieceLength"), 1),
                u = u.length > H.length ? u : H
            }
            for (u.length > 1 && u.includes("origin") && u.splice(u.indexOf("origin"), 1),
            u.sort((e,n)=>n.localeCompare(e)),
            c = 0; c < u.length; c++)
                d = h = null,
                g = "#current-browser-timestamp=" + +new Date,
                !b.h.sources.filter(e=>"360p" == e.label).length && ["sd", "mHd"].includes(u[c]) ? (d = "360p",
                h = b.protocol + "//" + b.m + "/" + e.id + g) : b.h.sources.filter(e=>"720p" == e.label).length || "hd" != u[c] ? !b.h.sources.filter(e=>"1080p" == e.label).length && ["fullHd", "origin"].includes(u[c]) && (d = "1080p",
                h = b.protocol + "//" + b.m + "/whw" + e.id + g) : (d = "720p",
                h = b.protocol + "//" + b.m + "/www" + e.id + g),
                b.h.sources.push({
                    file: h,
                    label: d,
                    default: "360p" == d,
            ...
            e.preview && "undefined" != typeof SoTrym && SoTrym && (y = (m = SoTrym("player")).vtt.create("https://preview.iamcdn.net/" + b.i + ".webp")) && ($ = {
                file: y,
                kind: "thumbnails"
            },
            b.h.tracks ? b.h.tracks.push($) : b.h.tracks = [$]),
...
var _0x2b36 = ["https://iamcdn.net/ban.html?v=", "\x76", "\x75\x6E\x64\x65\x66\x69\x6E\x65\x64", "\x72\x65\x6D\x6F\x76\x65", "\x61\x64\x64\x4C\x69\x73\x74\x65\x6E\x65\x72", "\x68\x72\x65\x66", "\x6C\x6F\x63\x61\x74\x69\x6F\x6E", "\x6F\x6E\x74\x6F\x75\x63\x68\x73\x74\x61\x72\x74", "\x6F\x6E\x6D\x73\x67\x65\x73\x74\x75\x72\x65\x63\x68\x61\x6E\x67\x65", "\x75\x73\x65\x72\x41\x67\x65\x6E\x74", "\x6D\x61\x74\x63\x68", "\x6C\x61\x75\x6E\x63\x68"]
...
void 0 === devtoolsDetector[_0x2b36[4]] ? top.location != self.location || (removeJwp(),
window[_0x2b36[6]][_0x2b36[5]] = urlBan,
setInterval(()=>{
    window[_0x2b36[6]][_0x2b36[5]] = urlBan,
    removeJwp()
}
, 1e3)) : (devtoolsDetector[_0x2b36[4]](o=>{
    ...
    !o || e && (i && r || n && a) || top.location != self.location && (removeJwp(),
    window[_0x2b36[6]][_0x2b36[5]] = urlBan,
    setInterval(()=>{
        window[_0x2b36[6]][_0x2b36[5]] = urlBan,
        removeJwp()
